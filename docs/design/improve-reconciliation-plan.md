...
| WS-1 salience vector (#618) | done | c7db502a, a182f037, bc99cc57, 03652977, d4bef793, ddcb1957, 09f63cba, 5b522737, d3733862, 12bf2ec7, 889dda29, a316697b, 98c74a34 (13 commits) | pass / confirmed-green | 2 rounds / clean | All 8 plan steps implemented; 3 review-blocker fixes landed (stash-wide rank comparison, first-run marker, retrieval coverage for feedback-bearing refs); 5900 tests 0 fail. Non-blocking notes: orphaned `getRankScoresByRefs` export, step-7 cutover comparison absent (data constraint, not a gap), dampener wired to reflect/distill sort not `akmConsolidate`. T0 measurement deferred to WS-2 per plan language. |
| WS-2 outcome loop | done | 48db9fec..a88452c2 + post-fix commits (74a3d56f, 178e6ae4, e9a9091e, f9f24a32, a88452c2, 24c66c43, 4d66e42f, 24c11485) | pass | none | `asset_outcome` table + differential outcome signal implemented; `outcomeSalience` wired into salience vector. `outcomeWeightEnabled` flag is **default-off** (Part-V gate) — `w_o` activates only when set to `true` in config. Stale W_OUTCOME=0.0 and WS-2-HOOK markers removed. |
