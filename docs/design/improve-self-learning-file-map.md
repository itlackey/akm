...
- `docs/design/` — `improve-salience-working-reference.md` (end-to-end mental model, read first), `improve-vs-brain-analysis.md` (brain-model gap analysis), `improve-proactive-maintenance.md` + `-issue.md` (starvation root cause + fix), `improve-pipeline-deep-tuning-analysis.md` (multi-agent audit, prioritized roadmap), `improve-optimal-default-config.md` (fresh-install defaults), `improve-beta50-monitoring.md` (beta.50 baseline metrics), `improve-reconciliation-plan-review.md` (blocker review)
- `docs/technical/` — `improve-workflow.md` (command surface + flow diagram), `improve-pipeline-analysis-0.8.0.md`, `improve-autosync-investigation.md`
