...
| `default-engine` | The configured default LLM, agent, or SDK engine is missing or incomplete. | Correct `defaults.engine` / `defaults.llmEngine`; SDK engines also require the package, binary, and fallback LLM connection. |
