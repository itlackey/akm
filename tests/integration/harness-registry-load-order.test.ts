 ...
 * loads cleanly. A subprocess is required: an in-process import would hit a warm
 * module cache and never exercise the fresh-graph evaluation order (hence
 * tests/integration/ per the spawn rule).
 */
