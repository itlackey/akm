...
- **MUST NOT** create a `context-hub` provider type. Context-hub was always just a git repo. Any git-based stash source follows one path: clone, cache, register as filesystem stash, index through FTS5.
