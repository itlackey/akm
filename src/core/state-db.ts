...
// ── collapse/churn detector (R5, migration 016) ─────────────────────────────
//
// Canary-set + cycle-metrics persistence for the longitudinal collapse/churn
// detector (docs/design/improve-collapse-churn-detector-design.md). Same
// helper style as the recombine-hypotheses CRUD above.
