...
export const DEFAULT_IMPROVE_TASKS: readonly DefaultTaskSpec[] = [
  ...
  },
  {
    ...
    command: "akm improve --strategy consolidate --skip-if-locked",
    schedule: "20 */4 * * *",
  ...
  },
  {
    ...
    strategy: "thorough",
    command: "akm improve --strategy thorough --skip-if-locked",
    schedule: "15 2 * * *",
    description: "Full nightly quality sweep (daily 2:15am)",
    enableMode: "server",
  },
  {
    id: "akm-improve-catchup",
    strategy: "catchup",
    command: "akm improve --strategy catchup --skip-if-locked",
    schedule: null,
  ...
  },
  {
    ...
    command: "akm improve --strategy graph-refresh --skip-if-locked",
    schedule: "10 3 * * 0",
